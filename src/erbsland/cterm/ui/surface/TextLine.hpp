...
/// A configurable line with optional left, middle, and right fields.
class TextLine : public AbstractLine {
public:
...
public:
    /// Create a text line with fixed height `1`.
    explicit TextLine(ProtectedTag) noexcept;
    ~TextLine() override = default;

public:
    /// Create a configurable text line.
    /// @return The new text line.
    [[nodiscard]] static auto create() noexcept -> TextLinePtr;
