...
public: // ----- convenience methods -----
    ...
    virtual void setFrom(const ReadableBuffer &other, Char fillChar = Char::space());
...
public: // drawing methods
    ...
    /// @param combinationStyle The combination style for overwriting existing characters.
    virtual void
    fill(Rectangle rect, const Char &fillBlock, const CharCombinationStylePtr &combinationStyle = {}) noexcept;
    ...
    /// @param frameColor The base frame color. Any color from the frame style overlays this base color.
    virtual void drawFrame(Rectangle rect, FrameStyle frameStyle, Color frameColor = {}) noexcept;
    ...
    /// @param frameColor The base frame color. Any color from the frame style overlays this base color.
    virtual void
    drawFilledFrame(Rectangle rect, FrameStyle frameStyle, const Char &fillBlock, Color frameColor = {}) noexcept;
