...
class TerminalTest final : public el::UnitTest {
public:
    ...
    void testInputDelegatesToTheActiveBackend() {
        ...
        REQUIRE_EQUAL(input.read(std::chrono::milliseconds{125}), Key{Key::F5});
        ...
        REQUIRE_EQUAL(input.read(std::chrono::milliseconds{250}), Key{Key::Escape});
