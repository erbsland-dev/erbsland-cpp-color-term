...
public:
    void testRemainingWidthUsesTheCachedFullWidthForOffsetZero() {
        ...
        const auto word = paragraph::LayoutLineToken{paragraph::LayoutLineToken::Type::Word, 1, 3, 3};
    ...
    void testSplitAccountsForTheTrailingMarkerOnlyWhenTheWordContinues() {
        const auto text = String{U"ABCD"};
        const auto word = paragraph::LayoutLineToken{paragraph::LayoutLineToken::Type::Word, 0, 4, 4};
