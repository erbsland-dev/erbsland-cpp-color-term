...
public:
    ...
    void testWithColorReplacedAndWithBaseColorUseExpectedRules() {
        const auto base = Char{U'X', fg::Green, bg::Blue};
        const auto overlaid = Char{U'X', fg::Inherited, bg::Yellow}.withBase(Color{fg::BrightWhite, bg::Blue});
    ...
    void testWithOverlayAndWithBaseResolveColorAndAttributesTogether() {
        ...
        const auto overlaid = character.withOverlay(CharStyle{Color{fg::Inherited, bg::Black}, overlayAttributes});
        ...
        const auto based = character.withBase(CharStyle{Color{fg::BrightWhite, bg::Default}, baseAttributes});
